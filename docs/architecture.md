...
- **A type policy on one upload route and none on the other was the split, not
  ...
  already own. That refusal is a **heuristic and not a guarantee**: the text
