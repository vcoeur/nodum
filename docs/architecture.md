...
flowchart LR
    ...
    svc --> db[("SQLite (WAL): nodes · edges · versions · events · humans · agents · grants · sessions · assets · asset_blobs · renditions · url_tokens · merge_redirects")]
