...
| `nodum.migrations` | The append-only migration list — `0001_core` … `0015_cycle_stop_switch`. |
...
`AGENTS.md`. Phase 4 additions: `ingest_file`, `ingest_url`,
...
`0001_core` … `0015_cycle_stop_switch` — never edit a shipped migration;
